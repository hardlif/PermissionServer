...
import com.dxj.module.system.dao.MenuDao;
...
import com.dxj.module.system.domain.vo.MenuMetaVo;
import com.dxj.module.system.domain.vo.MenuVo;
    ...
    public void create(Menu resources) {
        ...
        if (resources.getIFrame()) {
            ...
            if (!(resources.getPath().toLowerCase().startsWith(http) || resources.getPath().toLowerCase().startsWith(https))) {
                throw new SkException("外链必须以http://或者https://开头");
            }
        }
